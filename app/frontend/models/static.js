const api = {
  ...
  "components": {
    "schemas": {
      ...
      "todo_list": {
        "x-rhino-model": {
          "model": "todo_list",
          "modelPlural": "todo_lists",
          "name": "todoList",
          "pluralName": "todoLists",
          "readableName": "Todo list",
          "pluralReadableName": "Todo lists",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/todo_lists",
          "searchable": false
      ...
      "todo_item": {
        "x-rhino-model": {
          "model": "todo_item",
          "modelPlural": "todo_items",
          "name": "todoItem",
          "pluralName": "todoItems",
          "readableName": "Todo item",
          "pluralReadableName": "Todo items",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/todo_items",
          "searchable": false
      ...
      "todo_comment": {
        "x-rhino-model": {
          "model": "todo_comment",
          "modelPlural": "todo_comments",
          "name": "todoComment",
          "pluralName": "todoComments",
          "readableName": "Todo comment",
          "pluralReadableName": "Todo comments",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/todo_comments",
          "searchable": false
        },
        "type": "object",
        "properties": {
      ...
      "reminder": {
        "x-rhino-model": {
          "model": "reminder",
          "modelPlural": "reminders",
          "name": "reminder",
          "pluralName": "reminders",
          "readableName": "Reminder",
          "pluralReadableName": "Reminders",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/reminders",
          "searchable": false
      ...
      "notification_setting": {
        "x-rhino-model": {
          ...
          "modelPlural": "notification_settings",
          "name": "notificationSetting",
          "pluralName": "notificationSettings",
          "readableName": "Notification setting",
          "pluralReadableName": "Notification settings",
          "ownedBy": "organization",
          "singular": false,
        ...
        "properties": {
          ...
          "reminders_enabled": {
            "x-rhino-attribute": {
              ...
              "readableName": "Reminders Enabled",
              "readable": true,
              "creatable": true,
              "updatable": true
            },
          ...
          "default_reminder_minutes_before": {
            "x-rhino-attribute": {
              "name": "default_reminder_minutes_before",
              "readableName": "Default Reminder Minutes Before",
              "readable": true,
              "creatable": true,
              "updatable": true
            },
          ...
          "default_delivery_method": {
            "x-rhino-attribute": {
              ...
              "readableName": "Default Delivery Method",
              "readable": true,
              "creatable": true,
              "updatable": true
            },
          ...
          "vibration_enabled": {
            "x-rhino-attribute": {
              ...
              "readableName": "Vibration Enabled",
              "readable": true,
              "creatable": true,
              "updatable": true
            },
      ...
      "system_setting": {
        "x-rhino-model": {
          ...
          "modelPlural": "system_settings",
          "name": "systemSetting",
          "pluralName": "systemSettings",
          "readableName": "System setting",
          "pluralReadableName": "System settings",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/system_settings",
          "searchable": false
        },
        "type": "object",
        "properties": {
      ...
      "audit_log": {
        "x-rhino-model": {
          "model": "audit_log",
          "modelPlural": "audit_logs",
          "name": "auditLog",
          "pluralName": "auditLogs",
          "readableName": "Audit log",
          "pluralReadableName": "Audit logs",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/audit_logs",
          "searchable": false
        ...
        "properties": {
          ...
          "target_identifier": {
            "x-rhino-attribute": {
              ...
              "readableName": "Target Identifier",
              "readable": true,
              "creatable": true,
              "updatable": true
            },
  ...
  "paths": {
    ...
    "/api/todo_comments": {
      "get": {
        "operationId": "todo_comment-index",
        "parameters": [
      ...
      "post": {
        "operationId": "todo_comment-create",
        "parameters": [
    ...
    "/api/todo_comments/:id": {
      "get": {
        "operationId": "todo_comment-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "todo_comment-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "todo_comment-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/notification_settings": {
      ...
      "post": {
        "operationId": "notification_setting-create",
        "parameters": [
    ...
    "/api/notification_settings/:id": {
      ...
      "delete": {
        "operationId": "notification_setting-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/system_settings": {
      "get": {
        "operationId": "system_setting-index",
        "parameters": [
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/system_setting"
                }
              }
            }
          },
      ...
      "post": {
        "operationId": "system_setting-create",
        "parameters": [
    ...
    "/api/system_settings/:id": {
      "get": {
        "operationId": "system_setting-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "system_setting-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "system_setting-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
